			...
			<div class="contents">
				<div class="contents-title">
					...
					<form action=""
						...
						<a class="search-btn cursor" id="searchbtn"
	...
	<div id="info_modal" class="modal-dragscroll">
		...
		<div style="text-align: center; margin-top: 30px;">
			...
			<button  class="modal-close-btn cursor"
				style="cursor:pointer; padding: 5px 27px 6px; color: #444; letter-spacing: -1px; border: 1px solid #dadada; background: #dadada;">취소</button>
		</div>
