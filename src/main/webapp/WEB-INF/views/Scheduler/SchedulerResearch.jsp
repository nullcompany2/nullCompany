...
<script>
  ...
  $(document).on("click", ".ta", function(){
							...
							<div class="H-personnel-subNavi2 underline" style="border: none">
								<div class="H-personnel-subNavi2 Depth01-1">
									...
									<li class="subTitle"><label for="calendar_view"
										...
										<button id="individual2" class="calbtn" style="cursor: pointer;">만들기</button> <br>
    ...
    top: 10px;">
                ...
                <div class="contents-wrap drag-scrollbar" style="z-index:1010">
			...
			<!-- 일정 추가 모달 -->
					...
					<!-- 내 캘린더 모달 -->
					<div id="individualmodal2" class="modal-dragscroll">
    	...
    	$("#individualmodal2").hide();
    	$("#editindividualmodal").hide();
    	$("#com_detailmodal").hide();
