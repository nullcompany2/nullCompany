			...
			<div>
				<div style="width: 90%; margin: auto;">
					...
					<input type="hidden" name="renameFileName" value="${ b.renameFileName }">
						...
						&nbsp;작성자&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="text" name="bWriter" style="width: 3%;" value= " ${ b.bWriter }" readonly/>  <br>
						
						&nbsp;제목&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
						<input type="text" name="bTitle" style="width: 60%;" placeholder="제목을 입력해주세요." value="${b.bTitle}" /> <br>
