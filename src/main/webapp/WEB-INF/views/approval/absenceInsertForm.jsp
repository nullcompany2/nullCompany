    		...
    		// 문서 기안하기
   	    	$('#draftBtn').on('click',function(){
	            ...
	            var reason = $('#reason').val();
   	            ...
   	            location.href = "insertAbsenceDocumet.do?docTempNo="+docTempNo+"&startDate="+startDate
   	            		      + "&endDate="+endDate+"&totalDate="+totalDate+"&reason="+reason;
   	    	});
				...
				<div class="c-ic">
                    ...
                    <table class="appr_insert_table3" >
                        <tbody>
							...
							<tr id="tr13">
								<td><span>사유</span></td>
								<td><input type="text" id="reason" placeholder="휴직 사유를 입력하세요"/></td>
							</tr>
						</tbody>
					</table>
					<!-- 휴가/휴직 일수 계산 함수-->
                            ...
                            $("#calc").on("click",function(){
                                ...
                                if(start != "" && end != ""){
                                    ...
                                    if(day1.getTime() > day2.getTime()){
                                        alert("잘못 입력하셨습니다. 휴직 종료일을 확인하세요.");
                                    }else{
                                        while(true){

                                            if(startDate.getTime() > endDate.getTime()){
                                                if(calcDate == 0){
                                                    alert("주말은 휴직 일수에 포함되지 않습니다.");
                                                    $("#period").empty();
